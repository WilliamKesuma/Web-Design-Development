...
<head>
    ...
    <title><?php echo $__env->yieldContent("title", "Title Page"); ?></title>
    <!-- Font Awesome -->
    ...
    <div class="container">
      <div class="row gy-3">
        ...
        <div class="col-lg-2 col-sm-4 col-4">
          <a href="<?php echo e(url('/')); ?>" target="_blank" class="float-start">
...
<?php /**PATH C:\xampp\htdocs\commerce\resources\views/template/header.blade.php ENDPATH**/ ?>