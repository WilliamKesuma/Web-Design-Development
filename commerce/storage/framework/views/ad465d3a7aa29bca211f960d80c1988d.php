  ...
  <!-- Jumbotron -->
    ...
    <div class="container my-5">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
            <a href="<?php echo e(url("/product/{$product->id}-{$product->name}")); ?>">
                <div class="card w-100 my-2 shadow-2-strong">
                <img src="<?php echo e($product->image); ?>" class="card-img-top" style="aspect-ratio: 1 / 1" />
...
<?php echo $__env->make("template.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\commerce\resources\views/home.blade.php ENDPATH**/ ?>